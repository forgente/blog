...
and to [0x5c](https://github.com/0x5c), Nils Sandmann, [Max Mehl](https://mehl.mx), and Andreas Shimokawa who all independently reported the API 2FA bypass security loophole.
